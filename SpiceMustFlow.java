...
from the scorching sands of Arrakis,
...
After it has been mined for a day, the yield drops by 10, meaning on the second day it’ll produce
 10 less spice than on the first, on the third day 10 less than on the second, and so on
  (see examples). 
...
The mining crew consumes 26 spice every day at the end of their shift and an additional 26
 after the mine has been exhausted. Note that the workers cannot consume more spice than there
  is in storage. 
...
public class SpiceMustFlow {
	public static void main(String[] args) {
        ...
        while (number>0){
            ...
            lastMining+=number-26;
            number-=10;
            count+=1;
        }
        System.out.println(count);
        System.out.println(lastMining);
	}
}
